...
'Ikke utført  ved innkomst:' = 
      addmargins(table(HovedSkjema12mnd$ShNavn[HovedSkjema12mnd$ANeuNoMeasure == -1 
                                               & HovedSkjema12mnd$AAis == -1])),
'Ikke utført ved utreise:' =
      addmargins(table(HovedSkjema12mnd$ShNavn[HovedSkjema12mnd$FNeuNoMeasure == -1 
...
'Ikke utført ved utreise:' =
      addmargins(table(HovedSkjema28$ShNavn[HovedSkjema28$FNeuNoMeasure == -1 & HovedSkjema28$FAis == -1])),
'Utført, men ikke klassifiserbar, innkomst: ' = 
