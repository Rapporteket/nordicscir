...
NSFigGjsnTid <- function(RegData, valgtVar='RegForsinkelse', datoFra=datoFra, datoTil=datoTilReg,
                         datoUt = 1, tidsenhet='Mnd', reshID=reshID,
                           enhetsUtvalg=1, valgtMaal='gjsn',
                         preprosess=0, outfile='RegForsinkelseGjsnTid.pdf')

NSFigGjsnGrVar(RegData, valgtVar='RegForsinkelse', valgtMaal='gjsn', grVar=grVar,
                              datoFra=datoFra, datoTil=datoTilReg, datoUt=1,
