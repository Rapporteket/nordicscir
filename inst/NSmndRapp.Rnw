...
\caption{Antall dager på sykehus før rehabilitering for ikke-traumatiske skader}
\end{figure}
\end{frame}
...
\caption{Antall dager på sykehus før rehabilitering for traumatiske skader}
\end{figure}
\end{frame}
