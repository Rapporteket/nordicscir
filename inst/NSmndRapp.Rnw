...
\begin{frame}[fragile] {Kontrollskjema er nå filtrert på NoControll=FALSE og CNum=1}
Ikke vise i endelig versjon
[exclude]
...
\begin{frame}[fragile]{Tas ut til koblingsnøkkel for kontrollskjema er riktig. Har filtrert kontrollskjema på NoControl=FALSE og CNum=1}
