...
Kontroll <- Kontroll[Kontroll$NoControl=='False', ] # & Kontroll$CNum==1, ]
...
RaaTab <- data.frame(Sykehus = HovedSkjema12mnd$ShNavn,
      ...
      Funksjon = HovedSkjema12mnd$SkjemaGUID %in% AktivFunksjon$HovedskjemaGUID,
      Tilfredshet = HovedSkjema12mnd$SkjemaGUID %in% 
            AktivFunksjon$HovedskjemaGUID[AktivFunksjon$SkjemaGUID %in% AktivTilfredshet$HovedskjemaGUID]
)
...
RaaTabKtr <- data.frame(Sykehus = Kontroll$HealthUnitShortName,
      ...
      Funksjon = Kontroll$SkjemaGUID %in% AktivFunksjon$HovedskjemaGUID,
      Tilfredshet = Kontroll$SkjemaGUID %in% 
            AktivFunksjon$SkjemaGUID[AktivFunksjon$SkjemaGUID %in% AktivTilfredshet$HovedskjemaGUID]
)
...
'Ikke utført  ved innkomst:' = 
      addmargins(table(HovedSkjema12mnd$ShNavn[HovedSkjema12mnd$ANeuNoMeasure == TRUE #-1 
                                               & HovedSkjema12mnd$AAis == -1])),
'Ikke utført ved utreise:' =
      addmargins(table(HovedSkjema12mnd$ShNavn[HovedSkjema12mnd$FNeuNoMeasure == TRUE #-1 
...
'Ikke utført ved innkomst:' = 
#      addmargins(table(HovedSkjema28$ShNavn[HovedSkjema28$ANeuNoMeasure == -1 & HovedSkjema28$AAis == -1])),
