...
```{r isRealData, eval=!params$isRealData, echo=FALSE, results='asis'}
cat('<div class="alert alert-danger"><strong>Advarsel!</strong> Data kunne ikke lastes. Noe kan være alvorlig feil.</div>')
```
