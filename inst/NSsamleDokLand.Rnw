...
data(NorScirSampleData, package="NorScir")
...
NSdata <- NSPreprosesser(RegData=NSdata)
...
#Utvalg/datarensk
Ninn <- dim(NSdata)[1]
Utvalg <- NSUtvalg(RegData=NSdata, datoFra=datoFra, datoTil=datoTil)
...
utvalg <- switch(hvem,
	...
	Permisjon <- NSdata$Permisjon[intersect(utvalg,which(NSdata$Permisjon>0))]
...
AntTilHjem <- c(sum(NSdata$UtTil[utvalg]==1), sum(NSdata$UtTil[utvalg] %in% 1:10))
...
dum <- NSFigAndeler(NSdata, preprosess=0, valgtVar='DagerRehab', outfile='FigDagerRehab.pdf',
		datoFra=datoFra, datoTil=datoTil, traume=traume, enhetsUtvalg=0, reshID=reshID, hentData=0)
dum <- NSFigAndeler(NSdata, preprosess=0, valgtVar='Permisjon', outfile='FigPermisjon.pdf',
		datoFra=datoFra, datoTil=datoTil, traume=traume, enhetsUtvalg=0, reshID=reshID, hentData=0)
...
\begin{figure}[ht]
 \centerline{ \scalebox{\Sexpr{s1}}{\includegraphics{FigPermisjon.pdf}}  }
...
dum <- 	NSFigGjsnGrVar(NSdata, preprosess=0, valgtVar='Alder', outfile='FigAlderGjsn.pdf',
		datoFra=datoFra, datoTil=datoTil, valgtMaal='', erMann=erMann, traume=traume, hentData=0)
...
dum <- NSFigGjsnGrVar(NSdata, preprosess=0, valgtVar='DagerTilRehab', outfile='FigDagerTilRehabMed.pdf',
		datoFra=datoFra, datoTil=datoTil, valgtMaal='Med', erMann=erMann, traume=traume, hentData=0)
dum <- NSFigGjsnGrVar(NSdata, preprosess=0, valgtVar='Permisjon', outfile='FigPermisjonGjSn.pdf',
		datoFra=datoFra, datoTil=datoTil, valgtMaal='', erMann=erMann, traume=traume, hentData=0)
dum <- NSFigGjsnGrVar(NSdata, preprosess=0, valgtVar='Permisjon', outfile='FigPermisjonMed.pdf',
		datoFra=datoFra, datoTil=datoTil, valgtMaal='Med', erMann=erMann, traume=traume, hentData=0)
...
\begin{figure}[ht]
 \centerline{ \scalebox{\Sexpr{s1}}{\includegraphics{FigPermisjonGjSn.pdf}}  }
 \caption{\label{fig:PermisjonGjsn} Gjennomsnittlig antall døgn ute av sykehus, totalt og ved hvert sykehus.}
\end{figure}

\begin{figure}[ht]
 \centerline{ \scalebox{\Sexpr{s1}}{\includegraphics{FigPermisjonMed.pdf}}  }
 \caption{\label{fig:PermisjonMed} Median antall døgn ute av sykehus, totalt og ved hvert sykehus.}
\end{figure}
