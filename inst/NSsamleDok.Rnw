...
<<FigAlderGjsn, echo=FALSE>>=
	FigGjsnGrVar(NSdata, valgtVar='Alder', datoFra=datoFra, datoTil=datoTil,
...
<<FigDagerRehabGjsn, echo=FALSE>>=
	FigGjsnGrVar(NSdata,   valgtVar='DagerRehab', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume, preprosess=0, hentData=0)
@
}
...
<<FigDagerTilRehabGjsn, echo=FALSE>>=
	FigGjsnGrVar(NSdata,   valgtVar='DagerTilRehab', datoFra=datoFra, datoTil=datoTil,
...
<<FigPermisjonGjSn, echo=FALSE>>=
	FigGjsnGrVar(NSdata,   valgtVar='Permisjon', datoFra=datoFra, datoTil=datoTil,
...
<<FigOpphTotGjsn, echo=FALSE>>=
	FigGjsnGrVar(NSdata,   valgtVar='OpphTot', datoFra=datoFra, datoTil=datoTil,
		valgtMaal='', minald=minald, maxald=maxald, erMann=erMann, traume=traume, preprosess=0, 
    hentData=0)
@
}
