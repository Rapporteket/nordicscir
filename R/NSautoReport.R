...
#' @param registryApplication Name of application. To be used when there is more
#' than one application in a package. Default NULL.
...
NScreateAutoReport <- function(synopsis, package, type = "subscription", fun,
                               registryApplication=NULL,
